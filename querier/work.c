/*
A fully working querier.

Usage: usage: query <pageDirectory> <indexFile>[-q]
Where <crawlerDirectory> is an accessible directory generated by crawler
and <indexFile> is an index file for the corresponding crawler directory generated by the 
indexer.The optional -q flag allows queries to be loaded quietly from a file.


Created by: Vlado Vojdanovski, Claire Collins
 */
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
static int l=0;
static FILE *fOut; // the file to which the user can save the query results
